  ...
  // ═══ TASKS ═══
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        filter_sprint: { type: 'string' },
        filter_label: { type: 'string' },
        filter_favorite: { type: 'boolean' },
        filter_project_type: { type: 'string' },
        filter_exclude_types: { type: 'string' },
        search: { type: 'string' },
        items: bulkItemsProperty,
      },
      required: ['action'],
    ...
    input_schema: {
      ...
      properties: {
        ...
        items: {
          ...
          description: 'For bulk_create/bulk_delete, provide an array of comment objects with task_id plus content or comment_id.',
        },
      },
      required: ['action'],
    },
